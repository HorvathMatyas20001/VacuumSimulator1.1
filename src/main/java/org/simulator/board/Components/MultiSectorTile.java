...
public  abstract class MultiSectorTile extends ActiveTile{
    ...
    protected MultiSectorTile(StateType stateType, String activeStateText, String inactiveStateText) {
        super(stateType, activeStateText, inactiveStateText);
        isTopVacuum = false;
